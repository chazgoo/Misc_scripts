---
title: "Timecourse monoculture Analyses"
...
sample_id = dir("~/Dimensions/Kallistos/DC10/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC10",sample_id)
...
write.csv(st, file = "./timecourse_Outs/DC10_timecourse", row.names = FALSE)
...
## DC20 Inputs
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC20/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC20",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC20_timecourse", row.names = FALSE)
...
## DC30 Inputs
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC30/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC30",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC30_timecourse", row.names = FALSE)
...
## DC40 Inputs 
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC40/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC40",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC40_timecourse", row.names = FALSE)
...
## DC50 Inputs 
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC50/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC50",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC50_timecourse", row.names = FALSE)
...
## DC60 Inputs 
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC60/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC60",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC60_timecourse", row.names = FALSE)
...
## DC70 Inputs 
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC70/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC70",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC70_timecourse", row.names = FALSE)
...
## DC80 Inputs 
# Set sample_id to hold a list of directories containing kallisto data of interest
sample_id = dir("~/Dimensions/Kallistos/DC80/")

# Collate a list of paths to kallisto results directories using sample_id
kal_dirs = file.path("~/Dimensions/Kallistos/DC80",sample_id)
...
# Write the sleuth_table to a .csv
write.csv(st, file = "./timecourse_Outs/DC80_timecourse", row.names = FALSE)
